<?php
    ...
    $recommendation = "select f.* from film f , categorie c where c.id = f.categorie and c.nom = '$categorie' and f.id not in (select f2.id from film f2, vue v , user u where u.id = '$id' and u.id = v.idUser and v.idFilm= f2.id)";
